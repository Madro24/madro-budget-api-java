...
import proto.budget_pb2 as budget__pb2
...
class BudgetServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetBudget = channel.unary_unary(
                ...
                request_serializer=budget__pb2.BudgetRequest.SerializeToString,
                response_deserializer=budget__pb2.BudgetResponse.FromString,
...
def add_BudgetServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetBudget': grpc.unary_unary_rpc_method_handler(
                    servicer.GetBudget,
                    request_deserializer=budget__pb2.BudgetRequest.FromString,
                    response_serializer=budget__pb2.BudgetResponse.SerializeToString,
            ),
    }
...
class BudgetService(object):
    ...
    def GetBudget(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/budget.BudgetService/GetBudget',
            budget__pb2.BudgetRequest.SerializeToString,
            budget__pb2.BudgetResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
